...
import hwolf.validation.constraints.Equal
import hwolf.validation.constraints.isEqual
import hwolf.validation.utils.hasViolations
...
class ValidationBuilderTest {
    ...
    fun `Set message key - test 1`() {
        ...
        val actual = validator.validator(TestBean("xy"))
    ...
    fun `Set message key - test 2`() {
        ...
        val actual = validator.validator(TestBean("xy", prop2 = "yx"))

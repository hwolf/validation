...
import io.github.hwolf.kvalidation.i18n.messageInterpolator
...
class UserProfileTests: FunSpec({
    ...
    test("Validation example") {
        ...
        val messageInterpolator = messageInterpolator("io.github.hwolf.kvalidation.samples.UserProfileTests")
